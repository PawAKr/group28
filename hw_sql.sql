 1) Вывести се поля и все строки
...
7) Вывести id,имя,email и  дату создания пользоватей
...
15) Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которы в имени есть слово Andrey
...
22) Вывести пользователя у которы id меньше либо равно 137

select * from students where id <= 137

================================

23) Вывести пользователя у которых id  больше или равно 137
...
select * from students where password in  ('12333', '123313', '1m313')
...
select min(id) from students where id < 263

================================

29)Вывести макимальный id

select max(id) from students where id > 110
...
31) Вывести id пользователя,имя,дату создания пользователя.Отсортировать по порядку убивания даты добавления пользователя

select id, name, created_on from students order by created_on

===============================

32) Вывести id пользователя,имя,дату созданияпользователя.Отсортировать по порядку убывания даты добавления пользователя
